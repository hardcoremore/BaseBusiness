package modules
{
	...
	import interfaces.modules.IInvoicesModule;
	...
	import skins.Default.modules.InvoicesModuleSkin;
	...
	public class InvoicesModule extends SystemModuleBase implements IInvoicesModule, ILoadResourceRequester
	{
		...
		public function InvoicesModule()
		{
			super();
		}
		...
		override public function init():void
		{
			...
			setStyle( "skinClass", InvoicesModuleSkin );
		}
		...
		{ 
			var rh:ResourceHolderVo = new ResourceHolderVo();
				rh.title = resourceManager.getString( this.session.config.LOCALE_CONFIG.dictonaryResourceName, "invoices" );
				rh.width = 1200;
				rh.height = 800;
				rh.maximizable = true;
				rh.resizable = true;
				rh.minimizable = true;
				rh.maximized = true;
				rh.titleBarIcon = resourceManager.getClass( this.session.config.LOCALE_CONFIG.systemIconsResourceName, "invoiceIcon", this.session.skinsLocaleName );
